...
// End of reformatting the URL parameters
		...
		<div class="mainpanel">
			<div id="itsmap" style="position:relative;">
				...
				//echo '<img src=' .  $place["map"] . ' alt="Library floorplan" />';
				echo '<img src=' .  $place["map"] . ' alt="Library floorplan" width="60%" />';
				?>	
				
				<!-- experiment with scrolling -->
				<!-- ?php echo '<h1>HELLO</h1><script>window.scrollTo(' .  $place["xpos"] . ',' .  $place["ypos"] . ');</script>' ? -->
				<!-- end of experimenting with scrolling -->
